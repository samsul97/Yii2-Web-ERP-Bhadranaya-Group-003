...
<head>
    ...
    <?php $this->head() ?>
    <link rel="shortcut icon" href="<?=Url::base()?>/dist/img/holy_logo.png">
    <style type="text/css">
        .loadingin {
            top: 0px;
            left: 0px;
...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <!-- <li class="dropdown user user-menu"> -->
        <!-- <a href="#" class="dropdown-toggle" data-toggle="dropdown">
          <img src="<?=Url::base().Yii::$app->user->identity->image?>" class="user-image">
            <span class="hidden-xs"><?= Yii::$app->user->identity->name ?></span>
        </a> -->
        <!-- <ul class="dropdown-menu"> -->
            <!-- <li class="user-header">
            <img src="<?=Url::base().Yii::$app->user->identity->image?>" class="logo">
              <p>
          ...
          <!-- <li class="user-footer">
            <div class="pull-left">
              <a href="<?=Url::base()?>/update" class="nav-link">Update</a>
            </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="<?=Url::base()?>/dist/img/holy_logo.png"
           alt="Bahdranaya Group"
           class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Bhadranaya Group</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <!-- <div class="info">
        <i class="fas fa-sign-out-alt" style="color: #fff;"><a href="<?=Url::base()?>/logout"></a></i>
        </div> -->
      </div>
  ...
  <footer class="main-footer text-sm">
    ...
    <strong>Copyright &copy; 2010-2021 <a href="http://holycowsteak.com">Bhadranaya Group</a>.</strong> All rights reserved.
  </footer>
