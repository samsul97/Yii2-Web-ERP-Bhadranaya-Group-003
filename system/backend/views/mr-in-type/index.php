...
/* @var $searchModel backend\models\MrInTypeSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Tipe Inventori';
...
<div class="card table-card">
    ...
    <div class="card-body">
        <div class="card-text">
            <div class="mr-in-type-index">
                <p>
                    <?= Html::a('Tambah Tipe Inventori', ['create'], ['class' => 'btn btn-success']) ?>
                </p>
