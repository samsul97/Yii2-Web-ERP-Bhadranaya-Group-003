...
/**
 * TbPurSuppverifSearch represents the model behind the search form of `frontend\models\TbPurSuppverif`.
 */
class TbPurSuppverifSearch extends TbPurSuppverif
{
    ...
    public function rules()
    {
        return [
            ...
            [['type_business', 'img_nib', 'img_npwp', 'img_directur', 'name', 'residence_address', 'letter_address', 'telp', 'facsimile', 'email', 'account_number', 'swift_code', 'payment_method', 'offering_letter', 'created_at'], 'safe'],
        ];
    }
